                              ...
                              onPointerSignal: (event) {
                                if (event is PointerScrollEvent) {
                                  ...
                                  controller.constellationScrollController.jumpTo(
                                    controller.constellationScrollController.offset +
                                        constellationIconSize.width / 6 * offset.sign,
                                  );
                                }
                              },
                              child: Center(
                          ...
                          Padding(
                            ...
                            child: ConstrainedBox(
                              constraints: BoxConstraints(
                                minWidth: isSmall ? 0 : constellationIconSize.width,
                                minHeight: constellationIconSize.height,
                              ),
                              child: Material(
                                type: MaterialType.transparency,
                                child: Align(
