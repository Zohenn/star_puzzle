...
final sagittarius = Constellation(
  ...
  skyBoxOffset: const Offset(1550, 742),
  ...
  boundaries: [
    Position(0.35355191256830604, 0.999537037037037),
    Position(0.33989071038251367, 0.9777777777777777),
    Position(0.36010928961748634, 0.9449074074074074),
    Position(0.3144808743169399, 0.8212962962962963),
    Position(0.37841530054644806, 0.774537037037037),
    Position(0.3855191256830601, 0.7962962962962963),
    Position(0.41147540983606556, 0.7694444444444445),
    Position(0.4346994535519126, 0.7435185185185185),
    Position(0.4609289617486339, 0.7972222222222223),
    Position(0.4540983606557377, 0.8092592592592592),
    Position(0.4721311475409836, 0.836574074074074),
    Position(0.43278688524590164, 0.9254629629629629),
    Position(0.4702185792349727, 0.9601851851851851),
    Position(0.46120218579234973, 0.999537037037037)
  ],
  starSize: 12,
);